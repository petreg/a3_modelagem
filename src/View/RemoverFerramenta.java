 ...
 * @author Win10
 */
public class RemoverFerramenta extends javax.swing.JFrame {

    /**
     * Creates new form RemoverAmigo
     */
    public RemoverFerramenta() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RemoverFerramenta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RemoverFerramenta().setVisible(true);
            }
        });
    }
